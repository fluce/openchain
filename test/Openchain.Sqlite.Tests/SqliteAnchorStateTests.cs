...
namespace Openchain.Sqlite.Tests
{
    public class SqliteAnchorStateTests
    {
        ...
        {
            await this.anchorBuilder.CommitAnchor(new LedgerAnchor(binaryData[0], binaryData[1], 100),new LedgerAnchorProof[] { new LedgerAnchorProof(binaryData[0], "TestProvider", "TestPartyId", ByteString.Parse("DEADBEAF")) });
            await this.anchorBuilder.CommitAnchor(new LedgerAnchor(binaryData[2], binaryData[3], 101), new LedgerAnchorProof[] { new LedgerAnchorProof(binaryData[2], "TestProvider", "TestPartyId", ByteString.Parse("DEADBEFA")) });
